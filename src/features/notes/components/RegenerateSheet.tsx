            ...
            return (
              ...
              >
                <div className="flex-shrink-0 w-9 h-9 rounded-lg bg-stone-100 dark:bg-stone-800 flex items-center justify-center">
                  <Icon
                    size={18}
                    className="text-warm-text-secondary dark:text-dark-text-secondary"
                  />
                </div>
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-medium text-warm-text dark:text-dark-text">
                    {t(template.nameKey)}
                  </p>
                ...
                <ChevronRight
                  size={16}
                  className="flex-shrink-0 text-warm-text-secondary/40 dark:text-dark-text-secondary/40"
                />
              </button>
            );
          })}
